...
console.log(fetchedSignals);
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center px-4 py-8 space-y-6">
      {fetchedSignals?.map((signal) => (
        <div
          key={signal._id}
          className="bg-white shadow-xl p-6 rounded-2xl max-w-xl w-full relative"
        >
          ...
          <div className="space-y-4 text-lg">
            <p>
              ...
              {signal.location ? (
                <a
                  href={`https://www.google.com/maps?q=${signal.location}`}
                  target="_blank"
