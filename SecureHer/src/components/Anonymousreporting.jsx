...
const Anonymousreporting = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-red-50 to-red-100 flex flex-col items-center py-12">
      <h2 className="text-4xl font-semibold text-red-800 mb-6">📝 Incident Reporting</h2>

      <form onSubmit={formik.handleSubmit} className="w-3/4 bg-white p-6 rounded-2xl shadow-lg mt-6">
        <div className="mb-4">
          <label className="block text-lg text-gray-700 mb-2">Report Type</label>
          <input
            type="text"
        ...
        <div className="mb-6">
          <label className="block text-lg text-gray-700 mb-2">Incident Details</label>
          <textarea
            className="w-full p-4 border-2 rounded-xl focus:outline-none border-gray-300"
        ...
        <div className="mb-6">
          <label className="block text-lg text-gray-700 mb-2">Reporting Method</label>
