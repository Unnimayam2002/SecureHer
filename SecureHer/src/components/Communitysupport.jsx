              ...
              <ul className="space-y-4">
                {requests?.map((request) => (
                  <li key={request._id} className="p-4 bg-gray-100 rounded-lg shadow-md">
                    <p className="text-gray-700">{request.userId?.username}</p>
                    <p className="text-gray-700">🆘 {request.requestDetails}</p>
                    ...
                    <p className="text-sm text-green-600">Status: {request.status}</p>
