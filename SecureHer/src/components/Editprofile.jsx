...
const Editprofile = () => {
  ...
  // Initialize state for editable profile details
  ...
  // Update state when user profile data is fetched
  useEffect(() => {
    if (userProfile?.user) {
      setUpdatedProfile({
        ...
        photo: userProfile.user.photo || null,
      });
    }
  }, [userProfile]);
  ...
  const handlePhotoChange = (e) => {
    ...
    if (file) {
      setUpdatedProfile((prev) => ({ ...prev, photo: URL.createObjectURL(file) }));
    }
  };
